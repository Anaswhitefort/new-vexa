  ...
  return (
    <Container as="footer" className="mt-24 w-full sm:mt-32 lg:mt-40">
      <FadeIn>
        ...
        <div className="mb-10 sm:mb-20 mt-16 sm:mt-24 flex flex-wrap items-end justify-between gap-x-6 gap-y-4 border-t border-neutral-950/10 pt-12">
          <Link href={"/"} aria-label="Home">
            <Logo fillOnHover>
              Vexa Ecommerce & Marketing Agency
            </Logo>
          </Link>
